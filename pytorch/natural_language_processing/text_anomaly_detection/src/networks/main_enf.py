...
def build_network(net_name, dataset, embedding_size=None, pretrained_model=None, update_embedding=True,
                  ...
                  word_vectors_cache='../data/word_vectors_cache', coupling_hidden_size=1024, coupling_hidden_layers=2, coupling_num_flows=1, coupling_num_mixtures=64, coupling_dropout=0.0, coupling_input_dropout=0.0, max_seq_len=256):
    ...
    net = ENFNet(embedding, coupling_hidden_size=coupling_hidden_size, coupling_hidden_layers=coupling_hidden_layers, coupling_num_flows=coupling_num_flows, coupling_num_mixtures=coupling_num_mixtures, coupling_dropout=coupling_dropout, coupling_input_dropout=coupling_input_dropout, max_seq_len=max_seq_len)
    return net
