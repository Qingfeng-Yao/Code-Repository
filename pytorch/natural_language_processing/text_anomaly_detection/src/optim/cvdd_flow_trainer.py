...
from networks.cvdd_flow_Net import CVDDFlowNet
...
class CVDDFloTrainer(BaseTrainer):
    ...
    def train(self, dataset: BaseADDataset, net: CVDDFlowNet):
        ...
        for epoch in range(self.n_epochs):
            ...
            for data in train_loader:
                ...
                # forward pass
                cosine_dists, context_weights, A, flow_loss_mean, _ = net(text_batch)
                ...
                loss = loss_emp + loss_P + flow_loss_mean
    ...
    def test(self, dataset: BaseADDataset, net: CVDDFlowNet, ad_score='context_dist_mean'):
        logger = logging.getLogger()
        ...
        with torch.no_grad():
            for data in test_loader:
                ...
                # forward pass
                cosine_dists, context_weights, A, flow_loss_mean, flow_loss_batch = net(text_batch)
                scores = context_weights * cosine_dists
                ...
                # ad_scores = flow_loss_batch + torch.mean(cosine_dists, dim=1)
...
def get_top_words_per_context(dataset, encoder, net, data_loader, device, k_top=25, k_sentence=100, k_words=10):
    ...
    with torch.no_grad():
        for data in data_loader:
            ...
            cosine_dists, _, _, _, _ = net(text_batch)
