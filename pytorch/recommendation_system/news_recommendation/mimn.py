...
class MIMNCell(nn.Module):
    def __init__(self, gpu_id, controller_units, memory_size, memory_vector_dim, read_head_num, write_head_num, embedding, output_dim=None, clip_value=20, shift_range=1, batch_size=128, mem_induction=0, util_reg=False, sharp_value=2.,):
