...
class EmbeddingLayer(nn.Module):
    ...
    def forward(self, inputs, initial_state=None):
        ...
        for dim, embedding_layer in enumerate(self.embeddings, 1): # starts the enumerate from 1, not 0. 
            ...
            # print(torch.pow(vocab_size, torch.arange(dim)), dim) # tensor([1]) 1
            ...
            #                    sparse_inputs[0], embedding_indices[0])  # torch.Size([1024, 2]) torch.Size([1024]) torch.int64 sparse inputs, embedding dims: tensor([16, 71]) tensor(16)
