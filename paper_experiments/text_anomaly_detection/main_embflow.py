...
from embedflow.general.train import get_default_train_arguments
from embedflow.general.mutils import get_param_val, general_args_to_params, get_device, create_channel_mask, create_optimizer_from_args
from embedflow.general.parameter_scheduler import add_scheduler_parameters, scheduler_args_to_params, create_scheduler
from embedflow.general.task import TaskTemplate
from embedflow.layers.categorical_encoding.mutils import add_encoding_parameters, encoding_args_to_params
from embedflow.layers.flows.distributions import add_prior_distribution_parameters, prior_distribution_args_to_params, create_prior_distribution
from embedflow.experiments.language_modeling.task import TaskLanguageModeling
from embedflow.experiments.language_modeling.flow_model import FlowLanguageModeling

import datasets
from cvdd_models import MyEmbedding
...
model = FlowLanguageModeling(model_params=model_params, vocab_size=dataset.encoder.vocab_size, vocab=None, dataset_class=None, emb=embedding)
