...
from embedflow.general.mutils import *
...
def get_default_train_arguments():
	...
	parser.add_argument("--cuda-device", default="cuda:0", help="cuda:0 | ...")
	# Training parameters
	parser.add_argument("--seed", help="Seed to make experiments reproducable", type=int, default=1)
	...
	# Dataset parameters
	parser.add_argument("--dataset", default="REUTERS_DATA", help="REUTERS_DATA | NEWSGROUP_DATA | IMDB_DATA")
	parser.add_argument("--normal_class", type=int, default=0, help="specify the normal class of the dataset (all other classes are considered anomalous).")
	parser.add_argument("--min_count", type=int, default=3, help="min count of words in the dataset")
	parser.add_argument("--max_seq_len", help="Maximum sequence length of training sentences.", type=int, default=450)
	parser.add_argument("--pretrain_model", default="GloVe_6B", help="GloVe_6B | FastText_en")
	parser.add_argument("--glove_dim", type=int, default=50, help="dimensionality of Glove 6B")
